...
Public Class dsEmployee
    ...
    Public Overrides Function Clone() As DataSet
        Dim cln As dsEmployee = CType(MyBase.Clone,dsEmployee)
        cln.InitVars
        Return cln
    End Function
    ...
    Private Sub InitClass()
        Me.DataSetName = "dsEmployee"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/dsEmployee.xsd"
    ...
    Public Class EmployeesDataTable
        ...
        Public Overloads Function AddEmployeesRow(ByVal Title As String, ByVal FirstName As String, ByVal LastName As String, ByVal HomePhone As String) As EmployeesRow
            Dim rowEmployeesRow As EmployeesRow = CType(Me.NewRow,EmployeesRow)
            rowEmployeesRow.ItemArray = New Object() {Title, FirstName, LastName, HomePhone, Nothing}
