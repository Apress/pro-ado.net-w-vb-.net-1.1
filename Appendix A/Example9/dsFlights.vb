...
Public Class dsFlights
    ...
    Public Overrides Function Clone() As DataSet
        Dim cln As dsFlights = CType(MyBase.Clone,dsFlights)
        cln.InitVars
        Return cln
    End Function
    ...
    Private Sub InitClass()
        Me.DataSetName = "dsFlights"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/dsFlights.xsd"
    ...
    Public Class tabFlightsDataTable
        ...
        Private columnID_PILOT As DataColumn
        ...
        Friend ReadOnly Property ID_PILOTColumn As DataColumn
            Get
                Return Me.columnID_PILOT
            End Get
        End Property
        ...
        Public Overloads Function AddtabFlightsRow(ByVal FLIGHTCODE As String, ByVal LeaveFrom As String, ByVal GoingTo As String, ByVal Depart As Date, ByVal Arrive As Date, ByVal FirstName As String, ByVal LastName As String) As tabFlightsRow
            Dim rowtabFlightsRow As tabFlightsRow = CType(Me.NewRow,tabFlightsRow)
            rowtabFlightsRow.ItemArray = New Object() {FLIGHTCODE, LeaveFrom, GoingTo, Depart, Arrive, FirstName, LastName, Nothing}
        ...
        Friend Sub InitVars()
            ...
            Me.columnID_PILOT = Me.Columns("ID_PILOT")
        End Sub
        ...
        Private Sub InitClass()
            ...
            Me.columnID_PILOT = New DataColumn("ID_PILOT", GetType(System.Int32), Nothing, System.Data.MappingType.Element)
            Me.Columns.Add(Me.columnID_PILOT)
            Me.columnFLIGHTCODE.AllowDBNull = false
            Me.columnID_PILOT.AutoIncrement = true
        End Sub
    ...
    Public Class tabFlightsRow
        ...
        Public Property FirstName As String
            Get
                Try 
                    Return CType(Me(Me.tabletabFlights.FirstNameColumn),String)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tabletabFlights.FirstNameColumn) = value
            End Set
        End Property
        ...
        Public Property LastName As String
            Get
                Try 
                    Return CType(Me(Me.tabletabFlights.LastNameColumn),String)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tabletabFlights.LastNameColumn) = value
            End Set
        End Property
        
        Public Property ID_PILOT As Integer
            Get
                Try 
                    Return CType(Me(Me.tabletabFlights.ID_PILOTColumn),Integer)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tabletabFlights.ID_PILOTColumn) = value
            End Set
        End Property
        ...
        Public Function IsFirstNameNull() As Boolean
            Return Me.IsNull(Me.tabletabFlights.FirstNameColumn)
        End Function
        
        Public Sub SetFirstNameNull()
            Me(Me.tabletabFlights.FirstNameColumn) = System.Convert.DBNull
        End Sub
        
        Public Function IsLastNameNull() As Boolean
            Return Me.IsNull(Me.tabletabFlights.LastNameColumn)
        End Function
        
        Public Sub SetLastNameNull()
            Me(Me.tabletabFlights.LastNameColumn) = System.Convert.DBNull
        End Sub
        
        Public Function IsID_PILOTNull() As Boolean
            Return Me.IsNull(Me.tabletabFlights.ID_PILOTColumn)
        End Function
        
        Public Sub SetID_PILOTNull()
            Me(Me.tabletabFlights.ID_PILOTColumn) = System.Convert.DBNull
        End Sub
    End Class
