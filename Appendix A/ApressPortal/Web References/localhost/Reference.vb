...
Namespace localhost
    ...
    Public Class Service1
        ...
        Public Sub New()
            MyBase.New
            Me.Url = "http://localhost/BltAirlinesWebServiceVB/Service1.asmx"
        End Sub
        
        '<remarks/>
        <System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/RetrieveFlights", RequestNamespace:="http://tempuri.org/", ResponseNamespace:="http://tempuri.org/", Use:=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle:=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)>  _
        Public Function RetrieveFlights() As dsWebService
            Dim results() As Object = Me.Invoke("RetrieveFlights", New Object(-1) {})
            Return CType(results(0),dsWebService)
        End Function
        
        '<remarks/>
        Public Function BeginRetrieveFlights(ByVal callback As System.AsyncCallback, ByVal asyncState As Object) As System.IAsyncResult
            Return Me.BeginInvoke("RetrieveFlights", New Object(-1) {}, callback, asyncState)
        End Function
        
        '<remarks/>
        Public Function EndRetrieveFlights(ByVal asyncResult As System.IAsyncResult) As dsWebService
    ...
    Public Class dsWebService
        ...
        Public Overrides Function Clone() As DataSet
            Dim cln As dsWebService = CType(MyBase.Clone,dsWebService)
            cln.InitVars
            Return cln
        End Function
        ...
        Private Sub InitClass()
            Me.DataSetName = "dsWebService"
            Me.Prefix = ""
            Me.Namespace = "http://tempuri.org/dsWebService.xsd"
        ...
        Public Class tabFlightsDataTable
            ...
            Private columnLeavingFrom As DataColumn
            ...
            Friend ReadOnly Property LeavingFromColumn As DataColumn
                Get
                    Return Me.columnLeavingFrom
                End Get
            End Property
            ...
            Public Overloads Function AddtabFlightsRow(ByVal FlightCode As String, ByVal LeavingFrom As String, ByVal GoingTo As String, ByVal Depart As Date, ByVal Arrive As Date) As tabFlightsRow
                Dim rowtabFlightsRow As tabFlightsRow = CType(Me.NewRow,tabFlightsRow)
                rowtabFlightsRow.ItemArray = New Object() {FlightCode, LeavingFrom, GoingTo, Depart, Arrive}
            ...
            Friend Sub InitVars()
                ...
                Me.columnLeavingFrom = Me.Columns("LeavingFrom")
            ...
            Private Sub InitClass()
                ...
                Me.columnLeavingFrom = New DataColumn("LeavingFrom", GetType(System.String), Nothing, System.Data.MappingType.Element)
                Me.Columns.Add(Me.columnLeavingFrom)
        ...
        Public Class tabFlightsRow
            ...
            Public Property LeavingFrom As String
                Get
                    Try 
                        Return CType(Me(Me.tabletabFlights.LeavingFromColumn),String)
                    Catch e As InvalidCastException
                        Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                    End Try
                End Get
                Set
                    Me(Me.tabletabFlights.LeavingFromColumn) = value
                End Set
            End Property
            ...
            Public Function IsFlightCodeNull() As Boolean
                Return Me.IsNull(Me.tabletabFlights.FlightCodeColumn)
            End Function
            
            Public Sub SetFlightCodeNull()
                Me(Me.tabletabFlights.FlightCodeColumn) = System.Convert.DBNull
            End Sub
            
            Public Function IsLeavingFromNull() As Boolean
                Return Me.IsNull(Me.tabletabFlights.LeavingFromColumn)
            End Function
            
            Public Sub SetLeavingFromNull()
                Me(Me.tabletabFlights.LeavingFromColumn) = System.Convert.DBNull
            End Sub
