...
Public Class basket
    ...
    Public Overrides Function Clone() As DataSet
        Dim cln As basket = CType(MyBase.Clone,basket)
        cln.InitVars
        Return cln
    End Function
    ...
    Private Sub InitClass()
        Me.DataSetName = "basket"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/basket.xsd"
    ...
    Public Class BasketRow
        ...
        Public Function IsSKUNull() As Boolean
            Return Me.IsNull(Me.tableBasket.SKUColumn)
        End Function
        
        Public Sub SetSKUNull()
            Me(Me.tableBasket.SKUColumn) = System.Convert.DBNull
        End Sub
