...
Public Class CustomerOrders
    ...
    Public Overrides Function Clone() As DataSet
        Dim cln As CustomerOrders = CType(MyBase.Clone,CustomerOrders)
        cln.InitVars
        Return cln
    End Function
    ...
    Private Sub InitClass()
        Me.DataSetName = "CustomerOrders"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/CustomerOrders.xsd"
    ...
    Public Class CustomersDataTable
        ...
        Private Sub InitClass()
            ...
            Me.Constraints.Add(New UniqueConstraint("CustomerOrdersKey1", New DataColumn() {Me.columnCustomerID}, true))
    ...
    Public Class OrdersDataTable
        ...
        Private Sub InitClass()
            ...
            Me.Constraints.Add(New UniqueConstraint("CustomerOrdersKey2", New DataColumn() {Me.columnOrderID}, true))
