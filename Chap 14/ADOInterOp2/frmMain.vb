...
#End Region
   ...
   Private Sub frmMain_Load(ByVal sender As System.Object, _
        ...
        RS.Open("SELECT Customers.*, ContactName + ' from ' + " _
                  & "CompanyName AS FullName FROM Customers", _
                 Connection, _
        ...
        lbCustomers.DataSource = DS.Tables("Customers")
      lbCustomers.DisplayMember = "FullName"
